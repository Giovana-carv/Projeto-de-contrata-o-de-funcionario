...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .nav .links .login {
        ...
        padding: 0.5rem 1.5rem; border-radius: 1.5rem;
    }
    ...
    .cliente-nome { font-size: 18px; font-weight: bold; }
    ...
    .btn-finalizar:hover { background-color: #218838; transform: scale(1.05); }
    ...
    .file-input-container { position: relative; width: 100%; margin-top: 5px; }
    .file-input-container input[type="file"] {
        opacity: 0; width: 100%; height: 40px; position: absolute; top: 0; left: 0; cursor: pointer;
    }
    .file-input-container .custom-file-btn {
    ...
    .file-input-container .custom-file-btn:hover {
        background-color: #e04326; transform: scale(1.03);
    }

    /* Texto do arquivo selecionado personalizado */
    .file-input-container .file-name {
        display: block; margin-top: 8px; margin-bottom: 15px;
        font-size: 14px; font-weight: bold;
        color: #ff4b2b; background-color: #fff5f0;
    ...
    body.dark { background:#1e1e1e; color: black; }
    body.dark h2 { color:white; }
    body.dark .card { background:#2a2a2a; color:white; }
    body.dark input[type="file"] { background:#3a3a3a; color:white; border: 1px solid #666; }
    body.dark .file-input-container .file-name { background-color:#3a3a3a; color:#ffb49a; }
            ...
            <div class="card">
                ...
                <form action="../php/finalizar_servico.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="file-input-container">
                        ...
                        <span class="custom-file-btn">Escolher arquivo</span>
                        <span class="file-name" id="file-name-<?= $row['id'] ?>"></span>
                    </div>
    ...
    fileInputs.forEach(input => {
        ...
        input.addEventListener("change", () => {
            if(input.files.length > 0) {
                fileNameSpan.textContent = `Arquivo selecionado: ${input.files[0].name}`;
            } else {
