...
// lógica de contratação aqui

$_SESSION['mensagem'] = "Funcionario contratado com sucesso! Espere uma resposta chegar no seu painel de notificações";
$_SESSION['tipo_mensagem'] = "sucesso";

$redirect = $_POST['redirect_to'] ?? '../cliente/painel_cliente.php';
