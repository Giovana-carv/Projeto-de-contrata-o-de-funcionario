        ...
        <?php if ($resFinalizados && $resFinalizados->num_rows > 0): ?>
            <?php while($row = $resFinalizados->fetch_assoc()): ?>
                <div class="servico">
                    ...
                    <?php if (!empty($row['imagem_servico'])): ?>
                        <img src="../uploads/<?= htmlspecialchars($row['imagem_servico']) ?>" alt="Serviço">
                    <?php else: ?>
